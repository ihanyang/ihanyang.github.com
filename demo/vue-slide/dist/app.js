...
Component.options.__file = "C:\\Users\\hanyang\\Desktop\\vue-slide\\example\\app.vue"
...
// module
exports.push([module.i, "\n.slide-container {\r\n\tposition: fixed;\r\n\ttop: 0;\r\n\tright: 0;\r\n\tbottom: 0;\r\n\tleft: 0;\r\n\toverflow: hidden;\r\n\tbackground-color: #000;\n}\n.slide-container p {\r\n\tposition: absolute;\r\n\ttop: .7rem;\r\n\tleft: 50%;\r\n\tcolor: #FFF;\r\n\tfont-size: .36rem;\r\n\ttransform: translateX(-50%);\n}\n.slide-wrapper {\r\n\tdisplay: flex;\n}\n.slide-item {\r\n\tdisplay: flex;\r\n\talign-items: center;\r\n\twidth: 100vw;\r\n\theight: 100vh;\r\n\toverflow: auto;\n}\n.slide-item img {\r\n\tdisplay: block;\r\n\twidth: 100%;\n}\n.no-flex {\r\n\tdisplay: block;\n}\n.scale-enter-active, .scale-leave-active {\r\n\ttransition: all .2s;\n}\n.scale-enter, .scale-leave-active {\r\n\topacity: 0;\r\n\ttransform: scale(.6);\n}\n.will {\r\n\twill-change: transform;\n}\r\n", "", {"version":3,"sources":["C:/Users/hanyang/Desktop/vue-slide/example/components/slide.vue?2100db58"],"names":[],"mappings":";AACA;CACA,gBAAA;CACA,OAAA;CACA,SAAA;CACA,UAAA;CACA,QAAA;CACA,iBAAA;CACA,uBAAA;CACA;AACA;CACA,mBAAA;CACA,WAAA;CACA,UAAA;CACA,YAAA;CACA,kBAAA;CACA,4BAAA;CACA;AAEA;CACA,cAAA;CACA;AACA;CACA,cAAA;CACA,oBAAA;CACA,aAAA;CACA,cAAA;CACA,eAAA;CACA;AACA;CACA,eAAA;CACA,YAAA;CACA;AAEA;CACA,eAAA;CACA;AACA;CACA,oBAAA;CACA;AACA;CACA,WAAA;CACA,qBAAA;CACA;AACA;CACA,uBAAA;CACA","file":"slide.vue","sourcesContent":["<style>\r\n.slide-container {\r\n\tposition: fixed;\r\n\ttop: 0;\r\n\tright: 0;\r\n\tbottom: 0;\r\n\tleft: 0;\r\n\toverflow: hidden;\r\n\tbackground-color: #000;\r\n}\r\n.slide-container p {\r\n\tposition: absolute;\r\n\ttop: .7rem;\r\n\tleft: 50%;\r\n\tcolor: #FFF;\r\n\tfont-size: .36rem;\r\n\ttransform: translateX(-50%);\r\n}\r\n\r\n.slide-wrapper {\r\n\tdisplay: flex;\r\n}\r\n.slide-item {\r\n\tdisplay: flex;\r\n\talign-items: center;\r\n\twidth: 100vw;\r\n\theight: 100vh;\r\n\toverflow: auto;\r\n}\r\n.slide-item img {\r\n\tdisplay: block;\r\n\twidth: 100%;\r\n}\r\n\r\n.no-flex {\r\n\tdisplay: block;\r\n}\r\n.scale-enter-active, .scale-leave-active {\r\n\ttransition: all .2s;\r\n}\r\n.scale-enter, .scale-leave-active {\r\n\topacity: 0;\r\n\ttransform: scale(.6);\r\n}\r\n.will {\r\n\twill-change: transform;\r\n}\r\n</style>\r\n\r\n<template>\r\n\t<transition name=\"scale\">\r\n\t\t<div class=\"slide-container\">\r\n\t\t\t<slide-base class=\"slide-wrapper will\" :length=\"imgs.length\" :currentIndex=\"currentIndex\" @changeIndex=\"changeIndex\">\r\n\t\t\t\t<div class=\"slide-item\" v-for=\"(img, index) of imgs\">\r\n\t\t\t\t\t<img :src=\"img\" @click=\"hiddenImg\" @load.once=\"load\">\r\n\t\t\t\t</div>\r\n\t\t\t</slide-base>\r\n\t\t\t<p>{{index + 1}}/{{imgs.length}}</p>\r\n\t\t</div>\r\n\t</transition>\r\n</template>\r\n\r\n<script>\r\n\timport slideBase from \"./slide_base\"\r\n\r\n\texport default {\r\n\t\tprops: {\r\n\t\t\timgs: {\r\n\t\t\t\ttype: Array,\r\n\t\t\t\trequired: true\r\n\t\t\t},\r\n\t\t\tcurrentIndex: {\r\n\t\t\t\ttype: Number,\r\n\t\t\t\tdefault: 0,\r\n\t\t\t}\r\n\t\t},\r\n\t\tdata() {\r\n\t\t\treturn {\r\n\t\t\t\tindex: this.currentIndex\r\n\t\t\t}\r\n\t\t},\r\n\t\tcomponents: {\r\n\t\t\tslideBase\r\n\t\t},\r\n\t\tmethods: {\r\n\t\t\tload(e) {\r\n\t\t\t\tconst target = e.target\r\n\t\t\t\tconst viewportHeight = window.innerHeight\r\n\r\n\t\t\t\tif (target.height > viewportHeight) {\r\n\t\t\t\t\ttarget.parentNode.classList.add(\"no-flex\")\r\n\t\t\t\t}\r\n\t\t\t},\r\n\t\t\thiddenImg() {\r\n\t\t\t\tthis.$emit(\"hiddenImg\")\r\n\t\t\t},\r\n\t\t\tchangeIndex(value) {\r\n\t\t\t\tthis.index = value\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n</script>"],"sourceRoot":""}]);
...
// module
exports.push([module.i, "\nbody, div, p, header {\r\n\tpadding: 0;\r\n\tmargin: 0;\n}\n#app {\r\n\twidth: 7.5rem;\r\n\tmargin: 0 auto;\n}\nheader {\r\n\tfont-size: .36rem;\r\n\ttext-align: center;\r\n\tborder-bottom: 1px solid #EEE;\r\n\tline-height: .88rem;\n}\n.img-list {\r\n\tdisplay: flex;\r\n\tjustify-content: space-between;\r\n\tflex-wrap: wrap;\r\n\tpadding: .24rem;\n}\n.img-item {\r\n\twidth: 2.2rem;\r\n\theight: 2.2rem;\r\n\tmargin-bottom: .24rem;\r\n\tbackground-repeat: no-repeat;\r\n\tbackground-position: center;\r\n\tbackground-size: cover;\n}\n.overflow {\r\n\theight: 100vh;\r\n\toverflow: hidden;\n}\r\n", "", {"version":3,"sources":["C:/Users/hanyang/Desktop/vue-slide/example/app.vue?31a29358"],"names":[],"mappings":";AACA;CACA,WAAA;CACA,UAAA;CACA;AACA;CACA,cAAA;CACA,eAAA;CACA;AACA;CACA,kBAAA;CACA,mBAAA;CACA,8BAAA;CACA,oBAAA;CACA;AACA;CACA,cAAA;CACA,+BAAA;CACA,gBAAA;CACA,gBAAA;CACA;AACA;CACA,cAAA;CACA,eAAA;CACA,sBAAA;CACA,6BAAA;CACA,4BAAA;CACA,uBAAA;CACA;AACA;CACA,cAAA;CACA,iBAAA;CACA","file":"app.vue","sourcesContent":["<style>\r\nbody, div, p, header {\r\n\tpadding: 0;\r\n\tmargin: 0;\r\n}\r\n#app {\r\n\twidth: 7.5rem;\r\n\tmargin: 0 auto;\r\n}\r\nheader {\r\n\tfont-size: .36rem;\r\n\ttext-align: center;\r\n\tborder-bottom: 1px solid #EEE;\r\n\tline-height: .88rem;\r\n}\r\n.img-list {\r\n\tdisplay: flex;\r\n\tjustify-content: space-between;\r\n\tflex-wrap: wrap;\r\n\tpadding: .24rem;\r\n}\r\n.img-item {\r\n\twidth: 2.2rem;\r\n\theight: 2.2rem;\r\n\tmargin-bottom: .24rem;\r\n\tbackground-repeat: no-repeat;\r\n\tbackground-position: center;\r\n\tbackground-size: cover;\r\n}\r\n.overflow {\r\n\theight: 100vh;\r\n\toverflow: hidden;\r\n}\r\n</style>\r\n\r\n<template>\r\n\t<div id=\"app\" :class=\"{overflow: slideStatus}\">\r\n\t\t<header>vue-slide</header>\r\n\t\t<div class=\"img-list\">\r\n\t\t\t<div class=\"img-item\" :style=\"{backgroundImage: 'url(' + img + ')'}\" v-for=\"(img, index) of imgs\" @click=\"showImg(index)\"></div>\r\n\t\t</div>\r\n\t\t<slide :imgs=\"imgs\" :currentIndex=\"index\" v-if=\"slideStatus\" @hiddenImg=\"hiddenImg\"></slide>\r\n\t</div>\r\n</template>\r\n\r\n<script>\r\n\timport slide from \"./components/slide\"\r\n\r\n\texport default {\r\n\t\tdata() {\r\n\t\t\treturn {\r\n\t\t\t\timgs: [\r\n\t\t\t\t\t\"./images/4eafaa70ly1fe80ipjpdkj22c02c07wh.jpg\",\r\n\t\t\t\t\t\"./images/5dad5135ly1fewkv62lz5j21ul11gkh4.jpg\",\r\n\t\t\t\t\t\"./images/6a3f5a25gy1fewugbrd06j20qp0qrgre.jpg\",\r\n\t\t\t\t\t\"./images/6ca647dcly1fewdrgbjaxj20k0183qa0.jpg\",\r\n\t\t\t\t\t\"./images/60a3704aly1fewsiubi4lj21w02d0hdt.jpg\",\r\n\t\t\t\t\t\"./images/00659XvZgy1fevofjc90zj31901o0x6r.jpg\",\r\n\t\t\t\t\t\"./images/6106a4f0ly1feww7tar4lj20ro0zkavl.jpg\",\r\n\t\t\t\t\t\"./images/734235e7gy1fepy8mqj3uj20yi1a04qq.jpg\",\r\n\t\t\t\t\t\"./images/734235e7gy1fepy9s952vj20yi1a04qq.jpg\",\r\n\t\t\t\t\t],\r\n\t\t\t\tindex: 0,\r\n\t\t\t\tslideStatus: false\r\n\t\t\t}\r\n\t\t},\r\n\t\tcomponents: {\r\n\t\t\tslide\r\n\t\t},\r\n\t\tcreated() {\r\n\t\t\tconst value = window.innerWidth\r\n\t\t\tconst deviceWidth = Math.min(640, value)\r\n\r\n\t\t\tdocument.documentElement.style.fontSize = `${deviceWidth / 7.5}px`\r\n\t\t},\r\n\t\tmethods: {\r\n\t\t\tshowImg(index) {\r\n\t\t\t\tthis.index = index\r\n\r\n\t\t\t\tthis.slideStatus = true\r\n\t\t\t},\r\n\t\t\thiddenImg() {\r\n\t\t\t\tthis.slideStatus = false\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n</script>"],"sourceRoot":""}]);
...
Component.options.__file = "C:\\Users\\hanyang\\Desktop\\vue-slide\\example\\components\\slide.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-10b71a8b", Component.options)
  } else {
    hotAPI.reload("data-v-10b71a8b", Component.options)
  }
})()}
...
Component.options.__file = "C:\\Users\\hanyang\\Desktop\\vue-slide\\example\\components\\slide_base.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] slide_base.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-53e9b235", Component.options)
  } else {
    hotAPI.reload("data-v-53e9b235", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    staticClass: "slide-wrapper will",
    attrs: {
      "length": _vm.imgs.length,
      "currentIndex": _vm.currentIndex
    },
    on: {
      "changeIndex": _vm.changeIndex
    }
  ...
  })), _c('p', [_vm._v(_vm._s(_vm.index + 1) + "/" + _vm._s(_vm.imgs.length))])], 1)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-10b71a8b", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    class: {
      overflow: _vm.slideStatus
    },
    attrs: {
      "id": "app"
    }
  }, [_c('header', [_vm._v("vue-slide")]), _c('div', {
  ...
  })), (_vm.slideStatus) ? _c('slide', {
    attrs: {
      "imgs": _vm.imgs,
      "currentIndex": _vm.index
    },
    on: {
      "hiddenImg": _vm.hiddenImg
    }
  }) : _vm._e()], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-480ac1de", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-53e9b235", module.exports)
  }
}
...
var update = __webpack_require__(2)("5e66ffda", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/.npminstall/css-loader/0.28.0/css-loader/index.js?sourceMap!../node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-10b71a8b\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/selector.js?type=styles&index=0!./slide.vue", function() {
     var newContent = require("!!../node_modules/.npminstall/css-loader/0.28.0/css-loader/index.js?sourceMap!../node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-10b71a8b\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/selector.js?type=styles&index=0!./slide.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("13d07973", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!./node_modules/.npminstall/css-loader/0.28.0/css-loader/index.js?sourceMap!./node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-480ac1de\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/selector.js?type=styles&index=0!./app.vue", function() {
     var newContent = require("!!./node_modules/.npminstall/css-loader/0.28.0/css-loader/index.js?sourceMap!./node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-480ac1de\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/.npminstall/vue-loader/11.3.4/vue-loader/lib/selector.js?type=styles&index=0!./app.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
